...
mb_rev_a_config:	unconfig
	@$(MKCONFIG) -a mb_rev_a arm arm926ejs da8xxevm davinci davinci
...
mb_manhattan_a07_config:    unconfig
	@$(MKCONFIG) -a mb_manhattan_a07 arm arm926ejs da8xxevm davinci davinci
